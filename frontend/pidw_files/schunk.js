    ...
    ["985"], {
        487: function () {
            window.tram = function (t) {
                ...
                var j = e.frame = (s = d.requestAnimationFrame || d.webkitRequestAnimationFrame || d.mozRequestAnimationFrame || d.oRequestAnimationFrame || d.msRequestAnimationFrame) && T.bind ? s.bind(d) : function (t) {
                    d.setTimeout(t, 16)
                },
                    M = e.now = (c = (u = d.performance) && (u.now || u.webkitNow || u.msNow || u.mozNow)) && T.bind ? c.bind(u) : Date.now || function () {
                        return +new Date
                    },
                    F = l(function (e) {
                        function n(t, e) {
                        ...
                        function s(t) {
                            var e;
                            this.timer && this.timer.destroy(), this.queue = [], this.active = !1, "string" == typeof t ? (e = {})[t] = 1 : e = "object" == typeof t && null != t ? t : this.props, f.call(this, e, h), l.call(this)
                        }
                    ...
                    O = l(function (t) {
                        ...
                        t.init = function (t, e, i, a) {
                            ...
                            var u, c, l, h = e[0];
                            i[2] && (h = i[2]), X[h] && (h = X[h]), this.name = h, this.type = i[1], this.duration = o(e[1], this.duration, n), this.ease = (u = e[2], c = this.ease, l = r, void 0 !== c && (l = c), u in f ? u : l), this.delay = o(e[3], this.delay, s), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = _.test(this.name), this.unit = a.unit || this.unit || B.defaultUnit, this.angle = a.angle || this.angle || B.defaultAngle, B.fallback || a.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + " " + this.duration + "ms" + ("ease" != this.ease ? " " + f[this.ease][0] : "") + (this.delay ? " " + this.delay + "ms" : ""))
                        }, t.set = function (t) {
                    ...
                    D = l(function (e) {
                        ...
                        e.init = function (t) {
                            ...
                            var t;
                            this.active || (this.start || (this.start = M()), this.active = !0, t = this, 1 === u.push(t) && j(o))
                        }, e.stop = function () {
                            var e, n, i;
        ...
        756: function (t, e, n) {
            var i, r, o, a, s, u, c, l, f, h, d, p, m, v, w, b, g, y, x, k, E = window.$,
                _ = n(487) && E.tram;
            t.exports = ((i = {}).VERSION = "1.6.0-Webflow", r = {}, o = Array.prototype, a = Object.prototype, s = Function.prototype, o.push, u = o.slice, c = (o.concat, a.toString, a.hasOwnProperty), l = o.forEach, f = o.map, h = (o.reduce, o.reduceRight, o.filter), d = (o.every, o.some), p = o.indexOf, m = (o.lastIndexOf, Object.keys), s.bind, v = i.each = i.forEach = function (t, e, n) {
                ...
                var i = [];
                return null == t ? i : h && t.filter === h ? t.filter(e, n) : (v(t, function (t, r, o) {
                    e.call(n, t, r, o) && i.push(t)
                }), i)
            }, w = i.some = i.any = function (t, e, n) {
                e || (e = i.identity);
                var o = !1;
                return null == t ? o : d && t.some === d ? t.some(e, n) : (v(t, function (t, i, a) {
                                        ...
                                        return function (n) {
                                            ...
                                            n.thirdPartyCookiesSupported = e,
                                                function (e, n) {
                                                    ...
                                                    return t.indexOf("//") >= 0 ? t : d("https://editor-api.webflow.com" + t)
        ...
        949: function (t, e, n) {
            ...
            function w(t) {
                o.env() && (h(t.design) && l.on("__wf_design", t.design), h(t.preview) && l.on("__wf_preview", t.preview)), h(t.destroy) && l.on("__wf_destroy", t.destroy), t.ready && h(t.ready) && function (t) {
                    if (m) {
                        t.ready();
                        return
                    }
            ...
            o.env.safari = /safari/.test(g) && !x && !k, y && f.on("touchstart mousedown", function (t) {
                i = t.target
            ...
            o.load = function (t) {
                ...
                t = t || {}, v = !0, l.triggerHandler("__wf_destroy"), null != t.domready && (m = t.domready), d.each(a, b), o.resize.off(), o.scroll.off(), o.redraw.off(), s = [], u = [], "pending" === r.state() && $()
            ...
            i.define("links", t.exports = function (t, e) {
                ...
                a.ready = a.design = a.preview = function () {
                    ...
                    for (var e = document.links, a = 0; a < e.length; ++a)(function (e) {
                        ...
                        if ("#" !== i && "" !== i) m(a, f, l.href === c.href || i === o || h.test(i) && d.test(o))
                    })(e[a]);
