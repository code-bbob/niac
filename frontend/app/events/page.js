...
function EventCard({ event, index }) {
  const isUpcoming =
    event.event_start_date && new Date(event.event_start_date) > new Date();

  const formattedDate = event.event_start_date
    ...
    >
        ...
        <div className="relative h-52 overflow-hidden">
          {event.image_url ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-navy to-navy-light flex items-center justify-center">
              <span className="font-serif text-3xl text-white/20 font-bold">
      ...
      <div className="p-6">
        ...
        {event.ticket_price ? (
          ...
          <div className="mt-3 mb-4 h-[1.375rem]" aria-hidden="true" />
        )}
      ...
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 bg-navy overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-8 text-center">
          ...
          <p className="reveal text-white/60 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            Discover conferences, summits, and programs hosted by the Nepal
            International ADR Center.
          </p>
        </div>
