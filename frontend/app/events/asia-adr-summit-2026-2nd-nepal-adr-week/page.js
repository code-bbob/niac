...
function Organizers() {
  const orgs = [
    ...
    },
    {
      ...
      text: [
        "Nepal International ADR Center (NIAC) is a leading ADR institution committed to accessible and credible dispute resolution services in Nepal. Established in 2013, NIAC brings together a distinguished network of jurists, legal practitioners, arbitrators, mediators, engineers, chartered accountants, management professionals, and academics dedicated to strengthening and enhancing dispute resolution. We are closely connected with leading regional and international ADR organizations across Asia and beyond for institutional and professional development.",
        "NIAC represents our collective effort and multidisciplinary strength, uniting esteemed professionals under an unwavering commitment to independence, fairness, and justice.",
        "Our vision extends far beyond individual dispute resolution. NIAC actively collaborates with the judiciary and the private sector to spearhead vital legal and institutional reforms, cultivating a resilient ecosystem where commercial and investment justice can thrive.",
        "Guided by a deep responsibility to our changing world, we champion climate justice and are proud to spearhead the creation of the Himalayan ADR Academy in Nepal. When we envision the Academy, we look past the towering majesty of the Himalayas and its importance to a vulnerable world. The Himalayas are far more than a breathtaking landscape; they are the living lungs and beating heart of our planet, serving as an essential water tower, air purifier, and climate stabilizer for nearly two-thirds of humanity.",
        "We are committed to promoting a robust justice system for corporate and commercial parties through wide institutional collaboration, the exchange of professional rosters, and exposure tours for ADR neutrals as part of our ongoing promise to advance ADR ecosystem in Nepal. We look forward to broader collaboration with global ADR partners in the days to come.",
      ],
      height: 200,
      width: 200,
    },
