...
export const metadata = {
  title: 'Mediation Panelist - NIAC',
  description: 'Explore our distinguished panel of mediation experts at the Nepal International ADR Center.',
  keywords: 'NIAC mediation panelists, mediators Nepal, ADR mediation, dispute resolution',
  openGraph: {
    title: 'Mediation Panelist | NIAC',
    description: 'Explore our distinguished panel of mediation experts.',
    url: `${baseUrl}/mediation-panelist`,
    type: 'website',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'NIAC Mediation Panelists',
    }],
  },
  alternates: {
    canonical: `${baseUrl}/mediation-panelist`,
  },
};

export default async function MediationPanelistPage() {
  const teams = await fetchTeams();
  const panelists = teams.filter(t =>
    t.panelist?.split(',').map(s => s.trim()).includes('Mediation Panelist')
  );
    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="relative overflow-hidden flex items-center justify-center pt-[200px] pb-[120px]">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="NIAC mediation panelists hero"
          />
          <div
        ...
        <div className="relative z-10 text-center px-8 max-w-4xl">
          ...
          <p className="text-lg leading-[1.6] text-white/90 max-w-2xl mx-auto">
            Our distinguished panel of mediation professionals committed to fair and efficient dispute resolution.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-[1280px] mx-auto px-8 pb-[120px]">
        <div className="bg-primary-container text-white px-10 py-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div>
            <h2 className="font-serif text-[28px] mb-2">Need a Mediator?</h2>
            <p className="text-sm text-white/70 max-w-xl">
              Contact the NIAC Secretariat to appoint a mediator or learn more about our mediation services.
            </p>
          </div>
